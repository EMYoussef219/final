          ...
          child: Column(
            ...
            [
              ...
              Padding(
                ...
                child: Text('Login ',
                  style: TextStyle(fontSize: MyDim.fontSizeLarge, fontWeight: FontWeight.bold),),
              ),
              Divider(
...
children: [
  ...
  Padding(
    padding: const EdgeInsets.only(top: 120.0,right: 10.0,left: 10.0),
    child: SizedBox(
      width: 300.0,
      child: TextFormField(
  ...
  Padding(
    ...
    child: Center(
      child: Container(
          ...
          }, child:Text('Login',style: TextStyle(fontSize:MyDim.fontSizeMedium,color: Colors.white),))),
    ),
  ),
