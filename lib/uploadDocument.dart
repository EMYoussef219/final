                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton(
                          ...
                          child: Text('Take Photo',style:TextStyle(color: Colors.white,fontSize: 15)),
                        ),
                      ),
                      SizedBox(width: 16),
                      Container(
                        ...
                        child: TextButton(
                          ...
                          child: Text('Choose from Gallery',style:TextStyle(color: Colors.white,fontSize: 15)),
                        ),
                      ),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      child: _isUploading
                          ...
                          : Text('Upload Document',style: TextStyle(color: Colors.white,fontSize: 18.0),),
                    ),
                  ),
                  SizedBox(
                    height: 32,
