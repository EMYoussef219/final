            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: MyDim.paddingUnit*9,right: MyDim.paddingUnit*5.2),
              ...
              Padding(
                padding: const EdgeInsets.only(right: MyDim.paddingUnit*7.3,),
                child: GestureDetector(child: Text('Adding/Deleting users'  ,style: TextStyle(fontSize: 25.0,),
                ),
                  onTap: (){
                    setState(() {
              ...
              Padding(
                padding: const EdgeInsets.only(left: MyDim.paddingUnit*0.7),
                child: SizedBox(
                  width: 370.0,
                  child: Text(
              ...
              //Username
              Padding(
                padding: const EdgeInsets.only(right: MyDim.paddingUnit*7.5),
                child: GestureDetector(child: Text('Resetting passwords  '  ,style: TextStyle(fontSize: 25.0,),
                ),
                  onTap: (){
                    setState(() {
              ...
              Padding(
                padding: const EdgeInsets.only(right: MyDim.paddingUnit*5, left: MyDim.paddingUnit*1.8,),
                child: GestureDetector(child: Text('Assigning user roles and permissions'  ,style: TextStyle(fontSize: 25.0,),
                ),
                  onTap: (){
                    setState(() {
